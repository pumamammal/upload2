...
if (!class_exists('Meks_Video_Importer_Import')):
    class Meks_Video_Importer_Import {
        ...
        private function get_post_content() {
            ...
            $content = '';
            $editor = $_POST['mvi-editor'];

            if (  empty( $editor ) || $editor == 'classic' ) {

                $content = $_POST['mvi-video-url'];
                
                if (!empty($_POST['mvi-description']) && $_POST['mvi-description'] == "on" && !empty($_POST['mvi-video-description'])) {
                    $content = $content . PHP_EOL . PHP_EOL . $_POST['mvi-video-description'] . '</p>';
                }
            ...
            if ( $editor == 'editor' ) {
                ...
                if ( !empty( $_POST['mvi-description'] ) && $_POST['mvi-description'] == "on" && !empty( $_POST['mvi-video-description'] ) ) {
                    $content .= PHP_EOL . PHP_EOL . '
                        <!-- wp:paragraph -->
                        <p>'.$_POST['mvi-video-description'].'</p>
                        <!-- /wp:paragraph -->';
                }
