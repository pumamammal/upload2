...
$vlog_translate = array(
	...
	'no_audios_message' => array( 'text' => esc_html__( 'No audio yet!', 'vlog' ), 'desc' => 'No audio yet!' ),
	'listen_later_message' => array( 'text' => esc_html__( 'Click on "Listen later" to put audio here', 'vlog' ), 'desc' => 'Click on "Listen later" to put audio here' ),
	...
	'listen_later' => array( 'text' => esc_html__( 'Listen Later', 'vlog' ), 'desc' => 'Listen later action label' ),
	'listen_later_remove' => array( 'text' => esc_html__( 'Remove', 'vlog' ), 'desc' => 'Remove from listen later action label' ),
	'cinema_mode' => array( 'text' => esc_html__( 'Cinema Mode', 'vlog' ), 'desc' => 'Cinema mode action label' ),
	'subscribe' => array( 'text' => esc_html__( 'Subscribe', 'vlog' ), 'desc' => 'Subscribe action label' ),
	...
	'log_in' => array('text' => esc_html__('Log in', 'vlog'), 'desc' => 'Label for login button in header login form'),
	'log_out' => array('text' => esc_html__('Log out', 'vlog'), 'desc' => 'Label for logout button in header login form'),
