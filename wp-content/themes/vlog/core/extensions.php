...
if(!function_exists('vlog_add_last_three_dots_to_menu')):
	function vlog_add_last_three_dots_to_menu($items, $args) {
		...
		$items .= '<li id="vlog-menu-item-more" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children" style="display: none"><a href="javascript:void(0)">&middot;&middot;&middot;</a><ul class="sub-menu"></ul></li>';
