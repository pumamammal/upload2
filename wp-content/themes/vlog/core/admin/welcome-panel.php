	...
	<div class="welcome-panel-content">
		...
		<div class="welcome-panel-column-container">
			...
			<div class="welcome-panel-column welcome-panel-last">
				...
				<a class="button button-primary button-hero" href="https://mekshq.com/documentation/vlog" target="_blank">Learn more</a> <span class="vlog-customize-welcome">or <a href="<?php echo esc_url(admin_url('admin.php?page=vlog_options')); ?>">start customizing</a> now</span>.
			</div>
