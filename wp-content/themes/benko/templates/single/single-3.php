            ...
            <?php else : ?>
                <?php if(has_post_thumbnail() ) { ?>
                    <?php if(!get_theme_mod('sp_post_thumb')) : ?>
                        <div class="post-image single-image">
                            <?php
                            $thumbnail_full = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), "full" );
                            ?>
                            <?php
                            $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), "benko-single-full" );
                            $bg_image="background-image:url('$thumbnail_src[0]')";
                            ?>
                            <figure class="wp-single-image">
                                <a  class="single-image-full" href="<?php echo esc_attr($thumbnail_full[0]);?>" style = "<?php echo esc_attr($bg_image);?>">
                                </a>
                            </figure>
                        </div>
                    <?php endif; ?>
