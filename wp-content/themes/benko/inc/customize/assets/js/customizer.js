(function ($) {
    ...
    $(document).ready(function() {
        ...
        controlSlider.each( function() {
            var inputField = $(this).find( '.benko-slider-range-input' ),
                sliderRange = $(this).find( '.benko-slider-range' );

            $(this).find('.benko-slider-range').slider({
                range: "min",
        ...
        $( '.benko-slider-range-input' ).on( 'keyup paste', function() {
            $(this).change();
        ...
        $( '.benko-slider-range-input' ).on( 'change', function() {
